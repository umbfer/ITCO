...
if eval_ata_risk:
    ...
    #  ["Histology subtypes"= 6, 9 AND "Histology vascular invasion" = 2]
    ...
    patient_lm_risk = patient_lm_risk[(cond1 & cond2 & (cond3 | (cond4 & cond5 & cond6)))&(~cond1_h & ~cond2_h & ~cond3_h & ~cond4_h & ~cond5_h& ~cond6_h)&(~cond1_mh &~cond2_mh &~cond3_mh & ~cond4_mh )]
    ...
    cond4 = patient_l_risk['hysurgicalmargins'] != 3
